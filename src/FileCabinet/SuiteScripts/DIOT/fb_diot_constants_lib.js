...
define([],function(){
    ...
    RECORD_INFO.VENDOR_RECORD.FIELDS.NOMBRE_EXTRANJERO = 'custentity_tko_nombre_extranjero';
    RECORD_INFO.VENDOR_RECORD.FIELDS.PAIS_RESIDENCIA = 'custentity_tko_pais_residencia';
    RECORD_INFO.VENDOR_RECORD.FIELDS.NACIONALIDAD = 'custentity_tko_nacionalidad';
    ...
    RECORD_INFO.VENDOR_BILL_RECORD.FIELDS.TIPO_TERCERO = 'custentity_tko_diot_prov_type';
    RECORD_INFO.VENDOR_BILL_RECORD.FIELDS.TIPO_OPERACION = 'custbody_tko_tipo_operacion'; 
    ...
    RECORD_INFO.VENDOR_BILL_RECORD.FIELDS.FILTER.TIPO_TERCERO = 'vendor.custentity_tko_diot_prov_type';
